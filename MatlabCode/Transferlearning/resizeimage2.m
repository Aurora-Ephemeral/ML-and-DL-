function [newpath,newpath2]=resizeimage2(picpath)
...
parfor j=1:400
   % preparation the storage folder
    ...
    % white balance
    [imgWB]=whiteBalance(imgRGB);
    
    % find the bounding box of image 
    [img_nobackground,~,~,~,~]=findedge(imgWB,imgRGB);
    
    % resize the image and save 
    A=imresize(img_nobackground,[227,227]);
    B=imresize(img_nobackground,[224,224]);
